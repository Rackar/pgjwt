...
-- ----------------------------
DROP TABLE IF EXISTS "nideshop_shipper" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "nideshop_user_level" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "nideshop_user" CASCADE;
CREATE TABLE "nideshop_user" (
  ...
  "user_level_id" integer  NOT NULL DEFAULT '1' references nideshop_user_level,
...
INSERT  INTO "nideshop_user" (id,username,password,nickname,mobile) VALUES (0,'test','test','测试用户', '18623211234');
INSERT  INTO "nideshop_user" (id,username,password,nickname,mobile) VALUES (1,'test','test','测试用户', '18623211234');
INSERT  INTO "nideshop_user" (id,username,password,nickname,mobile) VALUES (2,'test','test','测试用户', '18623211234');
INSERT  INTO "nideshop_user" (id,username,password,nickname,mobile) VALUES (3,'test','test','测试用户', '18623211234');
INSERT  INTO "nideshop_user" (id,username,password,nickname,mobile) VALUES (4,'test','test','测试用户', '18623211234');
INSERT  INTO "nideshop_user" (id,username,password,nickname,mobile) VALUES (11,'test','test','测试用户', '18623211234');
...
-- ----------------------------
DROP TABLE IF EXISTS "nideshop_ad_position" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "nideshop_ad" CASCADE;
CREATE TABLE "nideshop_ad" (
  "id" serial NOT NULL  PRIMARY KEY,
  "ad_position_id" integer  NOT NULL DEFAULT '1' references nideshop_ad_position ,
...
INSERT INTO "nideshop_ad" (image_url) VALUES ('http://yanxuan.nosdn.127.net/65091eebc48899298171c2eb6696fe27.jpg');
...
DROP TABLE IF EXISTS "nideshop_admin" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "nideshop_search_history" CASCADE;
CREATE TABLE "nideshop_search_history" (
  "id" serial NOT NULL  PRIMARY KEY,
  "keyword" char(50) NOT NULL,
  "from" varchar(45) NOT NULL DEFAULT '' ,
  "add_time" integer NOT NULL DEFAULT '0' ,
  "user_id" integer DEFAULT NULL references nideshop_user
) ;
...
-- ----------------------------
DROP TABLE IF EXISTS "nideshop_address" CASCADE;
CREATE TABLE "nideshop_address" (
  "id" serial  NOT NULL  PRIMARY KEY,
  "name" varchar(50) NOT NULL DEFAULT '',
  "user_id" integer  NOT NULL DEFAULT '0' references nideshop_user,
  "country_id" integer NOT NULL DEFAULT '0' references nideshop_region,
  "province_id" integer NOT NULL DEFAULT '0' references nideshop_region,
  "city_id" integer NOT NULL DEFAULT '0' references nideshop_region,
  "district_id" integer NOT NULL DEFAULT '0' references nideshop_region,
...
-- ----------------------------
DROP TABLE IF EXISTS "nideshop_attribute_category" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "nideshop_attribute" CASCADE;
CREATE TABLE "nideshop_attribute" (
  "id" serial  NOT NULL  PRIMARY KEY,
  "attribute_category_id" integer  NOT NULL DEFAULT '0' references nideshop_attribute_category,
  "name" varchar(60) NOT NULL DEFAULT '',
...
-- ----------------------------
DROP TABLE IF EXISTS "nideshop_brand" CASCADE;
...
CREATE TABLE "nideshop_brand" (
  ...
  "new_sort_order" smallint  NOT NULL DEFAULT '10'
) ;
